...
exports.createSetupWSettings = void 0;
const server_1 = require("../../app/settings/server");
const createSetupWSettings = () => server_1.settingsRegistry.addGroup('Setup_Wizard', function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield this.section('Organization_Info', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.add('Organization_Type', '', {
                    type: 'select',
                    values: [
                        {
                            key: 'community',
                ...
                yield this.add('Organization_Name', '', {
                    type: 'string',
                    wizard: {
                        step: 2,
                        order: 1,
                ...
                yield this.add('Allow_Marketing_Emails', true, {
                    type: 'boolean',
                });
                yield this.add('Register_Server', false, {
                    type: 'boolean',
                });
                yield this.add('Organization_Email', '', {
                    type: 'string',
                });
                yield this.add('Triggered_Emails_Count', 0, {
                    type: 'int',
                    hidden: true,
                });
            });
        });
        yield this.section('Cloud_Info', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.add('Nps_Url', 'https://nps.rocket.chat', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Supported_Versions_Token', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    secret: true,
                });
                yield this.add('Cloud_Url', 'https://cloud.rocket.chat', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Service_Agree_PrivacyTerms', false, {
                    type: 'boolean',
                });
                yield this.add('Cloud_Workspace_Id', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Name', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Client_Id', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Client_Secret', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Client_Secret_Expires_At', 0, {
                    type: 'int',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Registration_Client_Uri', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_PublicKey', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_License', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Workspace_Had_Trial', false, {
                    type: 'boolean',
                    hidden: true,
                    readonly: true,
                    secret: true,
                });
                yield this.add('Cloud_Workspace_Registration_State', '', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
                ...
                yield this.add('Cloud_Billing_Url', 'https://billing.rocket.chat', {
                    type: 'string',
                    hidden: true,
                    readonly: true,
                    enableQuery: {
...
exports.createSetupWSettings = createSetupWSettings;
