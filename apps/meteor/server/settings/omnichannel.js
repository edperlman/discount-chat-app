...
exports.createOmniSettings = void 0;
const core_typings_1 = require("@rocket.chat/core-typings");
const server_1 = require("../../app/settings/server");
const omnichannelEnabledQuery = { _id: 'Livechat_enabled', value: true };
const createOmniSettings = () => server_1.settingsRegistry.addGroup('Omnichannel', function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield this.add('Livechat_enabled', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
        });
        yield this.add('Livechat_title', 'Rocket.Chat', {
            type: 'string',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_title_color', '#C1272D', {
            type: 'color',
            editor: core_typings_1.SettingEditor.COLOR,
        ...
        yield this.add('Livechat_enable_message_character_limit', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_message_character_limit', 0, {
            type: 'int',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_display_offline_form', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_clear_local_storage_when_chat_ended', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_validate_offline_email', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_offline_form_unavailable', '', {
            type: 'string',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_offline_title', 'Leave a message', {
            type: 'string',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_offline_title_color', '#666666', {
            type: 'color',
            editor: core_typings_1.SettingEditor.COLOR,
            // allowedTypes: ['color', 'expression'],
            group: 'Omnichannel',
        ...
        yield this.add('Livechat_offline_message', '', {
            type: 'string',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_offline_email', '', {
            type: 'string',
            group: 'Omnichannel',
        ...
        yield this.add('Livechat_offline_success_message', '', {
            type: 'string',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_allow_switching_departments', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            section: 'Livechat',
        ...
        yield this.add('Livechat_show_agent_info', true, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_show_agent_email', true, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Omnichannel_allow_visitors_to_close_conversation', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            enableQuery: omnichannelEnabledQuery,
        });
        yield this.add('Livechat_request_comment_when_closing_conversation', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
        ...
        yield this.add('Livechat_conversation_finished_message', '', {
            type: 'string',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_conversation_finished_text', '', {
            type: 'string',
            multiline: true,
            group: 'Omnichannel',
            section: 'Livechat',
        ...
        yield this.add('Livechat_registration_form', true, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_name_field_registration_form', true, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_email_field_registration_form', true, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_guest_count', 1, { type: 'int', group: 'Omnichannel', hidden: true });
        yield this.add('Livechat_Room_Count', 1, {
            type: 'int',
            group: 'Omnichannel',
            i18nLabel: 'Livechat_room_count',
            hidden: true,
        });
        yield this.add('Livechat_enabled_when_agent_idle', true, {
            type: 'boolean',
            group: 'Omnichannel',
        ...
        yield this.add('Livechat_webhookUrl', '', {
            type: 'string',
            group: 'Omnichannel',
        ...
        yield this.add('Livechat_secret_token', '', {
            type: 'string',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_start', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_close', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_chat_taken', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_chat_queued', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_forward', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_offline_msg', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_visitor_message', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_agent_message', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Send_visitor_navigation_history_livechat_webhook_request', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_webhook_on_capture', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_lead_email_regex', '\\b[A-Z0-9._%+-]+@(?:[A-Z0-9-]+\\.)+[A-Z]{2,4}\\b', {
            type: 'string',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_lead_phone_regex', '((?:\\([0-9]{1,3}\\)|[0-9]{2})[ \\-]*?[0-9]{4,5}(?:[\\-\\s\\_]{1,2})?[0-9]{4}(?:(?=[^0-9])|$)|[0-9]{4,5}(?:[\\-\\s\\_]{1,2})?[0-9]{4}(?:(?=[^0-9])|$))', {
            type: 'string',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_history_monitor_type', 'url', {
            type: 'select',
            group: 'Omnichannel',
            section: 'Livechat',
        ...
        yield this.add('Livechat_http_timeout', 5000, {
            type: 'int',
            group: 'Omnichannel',
            section: 'CRM_Integration',
        ...
        yield this.add('Livechat_Visitor_navigation_as_a_message', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield server_1.settingsRegistry.addGroup('Omnichannel', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.section('Business_Hours', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield this.add('Livechat_enable_business_hours', false, {
                            type: 'boolean',
                            group: 'Omnichannel',
                            public: true,
        ...
        yield this.add('Livechat_continuous_sound_notification_new_livechat_room', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
        ...
        yield this.add('Livechat_fileupload_enabled', true, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
        ...
        // if the other is off.
        yield this.add('Livechat_enable_transcript', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
        ...
        yield this.add('Livechat_transcript_send_always', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            enableQuery: [{ _id: 'Livechat_enable_transcript', value: false }, omnichannelEnabledQuery],
        });
        yield this.add('Livechat_transcript_show_system_messages', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            enableQuery: omnichannelEnabledQuery,
        });
        yield this.add('Livechat_transcript_message', '', {
            type: 'string',
            group: 'Omnichannel',
            public: true,
        ...
        yield this.add('Livechat_transcript_email_subject', '', {
            type: 'string',
            group: 'Omnichannel',
            public: true,
            enableQuery: omnichannelEnabledQuery,
        });
        yield this.add('Omnichannel_enable_department_removal', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
        ...
        yield this.add('Livechat_registration_form_message', '', {
            type: 'string',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_AllowedDomainsList', '', {
            type: 'string',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_OfflineMessageToChannel_enabled', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_OfflineMessageToChannel_channel_name', '', {
            type: 'string',
            group: 'Omnichannel',
            section: 'Livechat',
            public: true,
        ...
        yield this.add('Livechat_Routing_Method', 'Auto_Selection', {
            type: 'select',
            group: 'Omnichannel',
            public: true,
            section: 'Routing',
        ...
        yield this.add('Livechat_accept_chats_with_no_agents', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Routing',
        ...
        yield this.add('Livechat_assign_new_conversation_to_bot', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'Routing',
        ...
        yield this.add('Livechat_guest_pool_max_number_incoming_livechats_displayed', 0, {
            type: 'int',
            group: 'Omnichannel',
            section: 'Routing',
            public: true,
        ...
        yield this.add('Livechat_show_queue_list_link', false, {
            type: 'boolean',
            group: 'Omnichannel',
            public: true,
            section: 'Routing',
        ...
        yield this.add('Livechat_External_Queue_URL', '', {
            type: 'string',
            group: 'Omnichannel',
            public: false,
            section: 'Routing',
        ...
        yield this.add('Livechat_External_Queue_Token', '', {
            type: 'string',
            group: 'Omnichannel',
            public: false,
            section: 'Routing',
        ...
        yield this.add('Omnichannel_queue_delay_timeout', 5, {
            type: 'int',
            group: 'Omnichannel',
        ...
        yield this.add('Livechat_Allow_collect_and_store_HTTP_header_informations', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'GDPR',
            public: true,
        ...
        yield this.add('Livechat_force_accept_data_processing_consent', false, {
            type: 'boolean',
            group: 'Omnichannel',
            section: 'GDPR',
            public: true,
        ...
        yield this.add('Livechat_data_processing_consent_text', '', {
            type: 'string',
            multiline: true,
            group: 'Omnichannel',
            section: 'GDPR',
        ...
        yield this.add('Livechat_agent_leave_action', 'none', {
            type: 'select',
            group: 'Omnichannel',
            section: 'Sessions',
            values: [
        ...
        yield this.add('Livechat_agent_leave_action_timeout', 60, {
            type: 'int',
            group: 'Omnichannel',
            section: 'Sessions',
        ...
        yield this.add('Livechat_agent_leave_comment', '', {
            type: 'string',
            group: 'Omnichannel',
            section: 'Sessions',
        ...
        yield this.add('Livechat_visitor_inactivity_timeout', 3600, {
            type: 'int',
            group: 'Omnichannel',
            section: 'Sessions',
        ...
        yield this.add('Omnichannel_call_provider', 'none', {
            type: 'select',
            public: true,
            group: 'Omnichannel',
...
exports.createOmniSettings = createOmniSettings;
await server_1.settingsRegistry.addGroup('SMS', function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield this.add('SMS_Enabled', false, {
            type: 'boolean',
            i18nLabel: 'Enabled',
        });
        yield this.add('SMS_Service', 'twilio', {
            type: 'select',
            values: [
                {
                    key: 'twilio',
        ...
        yield this.add('SMS_Default_Omnichannel_Department', '', {
            type: 'string',
        });
        yield this.section('Twilio', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.add('SMS_Twilio_Account_SID', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'twilio',
                ...
                yield this.add('SMS_Twilio_authToken', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'twilio',
                ...
                yield this.add('SMS_Twilio_FileUpload_Enabled', true, {
                    type: 'boolean',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'twilio',
                ...
                yield this.add('SMS_Twilio_FileUpload_MediaTypeWhiteList', 'image/*,audio/*,video/*,text/*,application/pdf', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'twilio',
        ...
        yield this.section('Voxtelesys', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.add('SMS_Voxtelesys_authToken', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'voxtelesys',
                ...
                yield this.add('SMS_Voxtelesys_URL', 'https://smsapi.voxtelesys.net/api/v1/sms', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'voxtelesys',
                ...
                yield this.add('SMS_Voxtelesys_FileUpload_Enabled', true, {
                    type: 'boolean',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'voxtelesys',
                ...
                yield this.add('SMS_Voxtelesys_FileUpload_MediaTypeWhiteList', 'image/*,audio/*,video/*,text/*,application/pdf', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'voxtelesys',
        ...
        yield this.section('Mobex', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.add('SMS_Mobex_gateway_address', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'mobex',
                ...
                yield this.add('SMS_Mobex_restful_address', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'mobex',
                ...
                yield this.add('SMS_Mobex_username', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'mobex',
                ...
                yield this.add('SMS_Mobex_password', '', {
                    type: 'password',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'mobex',
                ...
                yield this.add('SMS_Mobex_from_number', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'mobex',
                ...
                yield this.add('SMS_Mobex_from_numbers_list', '', {
                    type: 'string',
                    enableQuery: {
                        _id: 'SMS_Service',
                        value: 'mobex',
        ...
        yield this.section('External Frame', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.add('Omnichannel_External_Frame_Enabled', false, {
                    type: 'boolean',
                    public: true,
                    alert: 'Experimental_Feature_Alert',
                });
                yield this.add('Omnichannel_External_Frame_URL', '', {
                    type: 'string',
                    public: true,
                    enableQuery: {
                ...
                yield this.add('Omnichannel_External_Frame_Encryption_JWK', '', {
                    type: 'string',
                    public: true,
                    enableQuery: {
                        _id: 'Omnichannel_External_Frame_Enabled',
