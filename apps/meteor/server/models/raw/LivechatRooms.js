...
class LivechatRoomsRaw extends BaseRaw_1.BaseRaw {
    ...
    getQueueMetrics({ departmentId, agentId, includeOfflineAgents, options = {}, }) {
        ...
        const usersLookup = {
            $lookup: {
                ...
                pipeline: [
                    {
                        $match: Object.assign(Object.assign({ $expr: {
                                $eq: ['$_id', '$$servedById'],
    ...
    findAllNumberOfAbandonedRooms(_a) {
        return __awaiter(this, arguments, void 0, function* ({ start, end, departmentId, onlyCount = false, options = {}, }) {
            const match = {
                $match: {
                    't': 'l',
                    'metrics.visitorInactivity': {
                        $gte: yield (0, raw_1.getValue)('Livechat_visitor_inactivity_timeout'),
                    },
    ...
    findPercentageOfAbandonedRooms(_a) {
        return __awaiter(this, arguments, void 0, function* ({ start, end, departmentId, onlyCount = false, options = {}, }) {
            const match = {
                $match: {
                    t: 'l',
                            ...
                            $cond: [
                                {
                                    $and: [
                                        { $ifNull: ['$metrics.visitorInactivity', false] },
                                        {
                                            ...
                                            $gte: ['$metrics.visitorInactivity', yield (0, raw_1.getValue)('Livechat_visitor_inactivity_timeout')],
                                        },
                                    ],
                                },
                                1,
    ...
    findByVisitorId(visitorId, options, extraQuery = {}) {
        const query = Object.assign({ 't': 'l', 'v._id': visitorId }, extraQuery);
    ...
    findRoomsByVisitorIdAndMessageWithCriteria({ visitorId, searchText, open, served, onlyCount = false, source, options = {}, }) {
        const match = {
            $match: Object.assign(Object.assign(Object.assign({ 'v._id': visitorId }, (open !== undefined && !open && { closedAt: { $exists: true } })), (served !== undefined && served && { servedBy: { $exists: served } })), (source && {
    ...
    findRoomsWithCriteria({ agents, roomName, departmentId, open, served, createdAt, closedAt, tags, customFields, visitorId, roomIds, onhold, queued, options = {}, extraQuery = {}, }) {
        const query = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ t: 'l' }, extraQuery), (agents && { 'servedBy._id': { $in: agents } })), (roomName && { fname: new RegExp((0, string_helpers_1.escapeRegExp)(roomName), 'i') })), (departmentId && departmentId !== 'undefined' && { departmentId })), (open !== undefined && { open: { $exists: open }, onHold: { $ne: true } })), (served !== undefined && { servedBy: { $exists: served } })), (visitorId && visitorId !== 'undefined' && { 'v._id': visitorId }));
        if (open) {
    ...
    findOpen(extraQuery = {}) {
        return this.find(Object.assign({ t: 'l', open: true }, extraQuery));
    }
    ...
    closeRoomById(roomId, closeInfo, options) {
        ...
        return this.updateOne({
            ...
            $set: Object.assign(Object.assign(Object.assign({ closedAt, 'metrics.chatDuration': chatDuration, 'metrics.serviceTimeDuration': serviceTimeDuration, 'v.status': core_typings_1.UserStatus.OFFLINE }, (closer && { closer })), (closedBy && { closedBy })), (tags && { tags })),
            $unset: {
                open: 1,
            },
        }, options);
    ...
    updateDataByToken(token_1, key_1, value_1) {
        return __awaiter(this, arguments, void 0, function* (token, key, value, overwrite = true) {
            ...
            if (!overwrite) {
                const room = yield this.findOne(query, { projection: { livechatData: 1 } });
                if (!room) {
                    return false;
                }
    ...
    saveRoomById(_a) {
        return __awaiter(this, void 0, void 0, function* () {
            var { _id, topic, tags, livechatData } = _a, extra = __rest(_a, ["_id", "topic", "tags", "livechatData"]);
            const setData = Object.assign({}, extra);
            const unsetData = {};
            if (topic != null) {
    ...
    findByIds(ids, fields, extraQuery = {}) {
        ...
        const query = Object.assign({ t: 'l', _id: { $in: ids } }, extraQuery);
        return this.find(query, options);
    }
    ...
    findOneByVisitorTokenAndEmailThreadAndDepartment(visitorToken, emailThread, departmentId, options) {
        const query = Object.assign({ 't': 'l', 'v.token': visitorToken, '$or': [
    ...
    updateRoomCount() {
        return __awaiter(this, void 0, void 0, function* () {
            const livechatCount = yield models_1.Settings.incrementValueById('Livechat_Room_Count', 1, { returnDocument: 'after' });
            return livechatCount.value;
        });
    }
    findOpenByVisitorToken(visitorToken, options = {}, extraQuery = {}) {
        const query = Object.assign({ 't': 'l', 'open': true, 'v.token': visitorToken }, extraQuery);
        return this.find(query, options);
    }
    findOneOpenByContactChannelVisitor(association, options = {}) {
        const query = Object.assign({ 't': 'l', 'open': true, 'v._id': association.visitorId, 'source.type': association.source.type }, (association.source.id ? { 'source.id': association.source.id } : {}));
        return this.findOne(query, options);
    }
    ...
    findOneOpenByVisitorTokenAndDepartmentIdAndSource(visitorToken, departmentId, source, options = {}) {
        const query = Object.assign({ 't': 'l', 'open': true, 'v.token': visitorToken, departmentId }, (source && { 'source.type': source }));
        return this.findOne(query, options);
    }
    findOpenByVisitorTokenAndDepartmentId(visitorToken, departmentId, options = {}, extraQuery = {}) {
        const query = Object.assign({ 't': 'l', 'open': true, 'v.token': visitorToken, departmentId }, extraQuery);
        return this.find(query, options);
    }
    findByVisitorToken(visitorToken, extraQuery = {}) {
        const query = Object.assign({ 't': 'l', 'v.token': visitorToken }, extraQuery);
        return this.find(query);
    }
    findByVisitorIdAndAgentId(visitorId, agentId, options = {}, extraQuery = {}) {
        const query = Object.assign(Object.assign(Object.assign({ t: 'l' }, (visitorId && { 'v._id': visitorId })), (agentId && { 'servedBy._id': agentId })), extraQuery);
        return this.find(query, options);
    }
    findNewestByContactVisitorAssociation(association_1) {
        return __awaiter(this, arguments, void 0, function* (association, options = {}) {
            const query = Object.assign({ 't': 'l', 'v._id': association.visitorId, 'source.type': association.source.type }, (association.source.id ? { 'source.id': association.source.id } : {}));
            return this.findOne(query, Object.assign(Object.assign({}, options), { sort: { _updatedAt: -1 } }));
        });
    }
    ...
    findClosedRooms(departmentIds, options = {}, extraQuery = {}) {
        const query = Object.assign(Object.assign({ t: 'l', open: { $exists: false }, closedAt: { $exists: true } }, (Array.isArray(departmentIds) && departmentIds.length > 0 && { departmentId: { $in: departmentIds } })), extraQuery);
        return this.find(query, options);
    }
    ...
    getAnalyticsUpdateQuery(analyticsData, updater = this.getUpdater()) {
        ...
        if (analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.firstResponseTime) {
    ...
    getAnalyticsUpdateQueryBySentByAgent(room, message, analyticsData, updater = this.getUpdater()) {
        ...
        const visitorLastQuery = ((_a = room.metrics) === null || _a === void 0 ? void 0 : _a.v) ? room.metrics.v.lq : room.ts;
        const agentLastReply = ((_b = room.metrics) === null || _b === void 0 ? void 0 : _b.servedBy) ? room.metrics.servedBy.lr : room.ts;
    ...
    getTotalConversationsBetweenDate(t, date, { departmentId } = {}) {
        const query = Object.assign({ t, ts: {
    ...
    getAnalyticsMetricsBetweenDate(t, date, { departmentId } = {}, extraQuery = {}) {
        const query = Object.assign(Object.assign({ t, ts: {
                $gte: new Date(date.gte), // ISO Date, ts >= date.gte
                $lte: new Date(date.lte), // ISODate, ts <= date.lte
            } }, (departmentId && departmentId !== 'undefined' && { departmentId })), extraQuery);
        return this.find(query, {
    ...
    getAnalyticsMetricsBetweenDateWithMessages(t, date, { departmentId } = {}, extraQuery = {}, extraMatchers = {}) {
        return this.col.aggregate([
            {
                $match: Object.assign(Object.assign({ t, ts: {
                        $gte: new Date(date.gte), // ISO Date, ts >= date.gte
                        $lte: new Date(date.lte), // ISODate, ts <= date.lte
                    } }, (departmentId && departmentId !== 'undefined' && { departmentId })), extraMatchers),
            },
    ...
    countOpenByAgent(userId, extraQuery = {}) {
        const query = Object.assign({ 't': 'l', 'open': true, 'servedBy._id': userId }, extraQuery);
        return this.col.countDocuments(query);
    }
        ...
        const update = {
            $set: {
                servedBy: {
                    ...
                    ts: (_a = newAgent.ts) !== null && _a !== void 0 ? _a : new Date(),
                },
            },
        };
        return this.updateOne(query, update);
    ...
    getMACStatisticsForPeriod(period) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.col
                .aggregate([
                {
    ...
    getMACStatisticsBetweenDates(start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.col
                .aggregate([
                {
    ...
    setPriorityByRoomId(_roomId, _priority) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('Method not implemented.');
        });
    }
    unsetPriorityByRoomId(_roomId) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('Method not implemented.');
        });
    }
    ...
    unsetPredictedVisitorAbandonmentByRoomId(_roomId) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('Method not implemented.');
        });
    }
    associateRoomsWithDepartmentToUnit(_departments, _unitId) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('Method not implemented.');
        });
    }
    removeUnitAssociationFromRooms(_unitId) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('Method not implemented.');
        });
    }
    updateDepartmentAncestorsById(_rid, _departmentAncestors) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('Method not implemented.');
        });
    }
    ...
    setContactByVisitorAssociation(association, contact) {
        return this.updateMany(Object.assign({ 't': 'l', 'v._id': association.visitorId, 'source.type': association.source.type }, (association.source.id ? { 'source.id': association.source.id } : {})), {
            $set: Object.assign({ contactId: contact._id }, (contact.name ? { fname: contact.name } : {})),
        });
    }
    updateContactDataByContactId(oldContactId, contact) {
        const update = Object.assign(Object.assign({}, (contact._id ? { contactId: contact._id } : {})), (contact.name ? { fname: contact.name } : {}));
