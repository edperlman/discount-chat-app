...
(0, migrations_1.addMigration)({
    ...
    up() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, e_1, _b, _c;
            var _d;
            const isEE = license_1.License.hasValidLicense();
            if (isEE) {
                return;
            }
            if (!apps_1.Apps.self) {
            ...
            const apps = yield appsStorage.retrieveAllPrivate();
            try {
                for (var _e = true, _f = __asyncValues(apps.values()), _g; _g = yield _f.next(), _a = _g.done, !_a; _e = true) {
                    _c = _g.value;
                    _e = false;
                    const app = _c;
                    const updatedApp = Object.assign(Object.assign({}, app), { migrated: true });
