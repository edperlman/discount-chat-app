    ...
    'livechat:removeTag'(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!uid || !(yield (0, hasPermission_1.hasPermissionAsync)(uid, 'manage-livechat-tags'))) {
                throw new meteor_1.Meteor.Error('error-not-allowed', 'Not allowed', { method: 'livechat:removeTag' });
            }
            return (yield LivechatEnterprise_1.LivechatEnterprise.removeTag(id)).deletedCount > 0;
        });
    },
});
