...
class LoadBalancing {
    ...
    getNextAgent(department, ignoreAgentId) {
        return __awaiter(this, void 0, void 0, function* () {
            const nextAgent = yield models_1.Users.getNextLeastBusyAgent(department, ignoreAgentId);
            if (!nextAgent) {
                return;
            }
...
RoutingManager_1.RoutingManager.registerMethod('Load_Balancing', LoadBalancing);
