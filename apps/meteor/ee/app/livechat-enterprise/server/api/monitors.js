...
server_1.API.v1.addRoute('livechat/monitors', {
    ...
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return server_1.API.v1.success(yield (0, monitors_1.findMonitors)({
                text,
                pagination: {
                    offset,
                    count,
...
server_1.API.v1.addRoute('livechat/monitors/:username', {
    authRequired: true,
    permissionsRequired: ['manage-livechat-monitors'],
}, {
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return server_1.API.v1.success((yield (0, monitors_1.findMonitorByUsername)({
                username,
            })));
        });
    },
