...
const FederatedRoomList = ({ serverName, roomName, count }) => {
    ...
    const { mutate: onClickJoin, isLoading: isLoadingMutation } = (0, react_query_1.useMutation)(['federation/joinExternalPublicRoom'], (_a) => __awaiter(void 0, [_a], void 0, function* ({ id, pageToken }) {
        return joinExternalPublicRoom({ externalRoomId: id, roomName, pageToken });
    }), {
        onSuccess: (_, data) => {
