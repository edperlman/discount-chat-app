...
const RoomMenu = ({ rid, unread, threadUnread, alert, roomOpen, type, cl, name = '', hideDefaultOptions = false, }) => {
    ...
    const handleLeave = (0, fuselage_hooks_1.useEffectEvent)(() => {
    ...
    const handleToggleRead = (0, fuselage_hooks_1.useEffectEvent)(() => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    const handleToggleFavorite = (0, fuselage_hooks_1.useEffectEvent)(() => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    const menuOptions = (0, react_1.useMemo)(() => (Object.assign(Object.assign({}, (!hideDefaultOptions && Object.assign(Object.assign({ hideRoom: {
