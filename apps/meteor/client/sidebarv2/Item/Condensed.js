...
const Condensed = (_a) => {
    var { icon, title, avatar, actions, unread, menu, badges } = _a, props = __rest(_a, ["icon", "title", "avatar", "actions", "unread", "menu", "badges"]);
