...
const ThreadMessageContent = ({ message }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [isMessageEncrypted && (0, jsx_runtime_1.jsx)(fuselage_1.MessageBody, { children: t('E2E_message_encrypted_placeholder') }), !!(quotes === null || quotes === void 0 ? void 0 : quotes.length) && (0, jsx_runtime_1.jsx)(Attachments_1.default, { attachments: quotes }), !((_e = normalizedMessage.blocks) === null || _e === void 0 ? void 0 : _e.length) && !!((_f = normalizedMessage.md) === null || _f === void 0 ? void 0 : _f.length) && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (!encrypted || normalizedMessage.e2e === 'done') && ((0, jsx_runtime_1.jsx)(MessageContentBody_1.default, { md: normalizedMessage.md, mentions: normalizedMessage.mentions, channels: normalizedMessage.channels })) })), normalizedMessage.blocks && ((0, jsx_runtime_1.jsx)(UiKitMessageBlock_1.default, { rid: normalizedMessage.rid, mid: normalizedMessage._id, blocks: normalizedMessage.blocks })), !!attachments && (0, jsx_runtime_1.jsx)(Attachments_1.default, { id: (_h = (_g = message.files) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h._id, attachments: attachments }), oembedEnabled && !!((_j = normalizedMessage.urls) === null || _j === void 0 ? void 0 : _j.length) && (0, jsx_runtime_1.jsx)(UrlPreviews_1.default, { urls: normalizedMessage.urls }), ((_k = normalizedMessage.actionLinks) === null || _k === void 0 ? void 0 : _k.length) && ((0, jsx_runtime_1.jsx)(MessageActions_1.default, { message: normalizedMessage, actions: normalizedMessage.actionLinks.map((_a) => {
                ...
                }) })), normalizedMessage.reactions && Object.keys(normalizedMessage.reactions).length && (0, jsx_runtime_1.jsx)(Reactions_1.default, { message: normalizedMessage }), normalizedMessage.location && (0, jsx_runtime_1.jsx)(Location_1.default, { location: normalizedMessage.location }), broadcast && !!messageUser.username && normalizedMessage.u._id !== uid && ((0, jsx_runtime_1.jsx)(BroadcastMetrics_1.default, { username: messageUser.username, message: normalizedMessage })), readReceiptEnabled && (0, jsx_runtime_1.jsx)(ReadReceiptIndicator_1.default, { mid: normalizedMessage._id, unread: normalizedMessage.unread })] }));
};
exports.default = (0, react_1.memo)(ThreadMessageContent);
