...
exports.usePinMessageMutation = void 0;
...
const usePinMessageMutation = () => {
    const { t } = (0, react_i18next_1.useTranslation)();
    const pinMessage = (0, ui_contexts_1.useEndpoint)('POST', '/v1/chat.pinMessage');
    const dispatchToastMessage = (0, ui_contexts_1.useToastMessageDispatch)();
    const queryClient = (0, react_query_1.useQueryClient)();
    return (0, react_query_1.useMutation)({
        mutationFn: (message) => __awaiter(void 0, void 0, void 0, function* () { return pinMessage({ messageId: message._id }); }),
        onMutate: (message) => {
...
exports.usePinMessageMutation = usePinMessageMutation;
