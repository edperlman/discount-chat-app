...
const OmnichannelCallToggleReady = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(fuselage_1.Sidebar.TopBar.Action, Object.assign({ icon: getIcon(), disabled: inCall, "aria-checked": registered, "aria-label": t('VoIP_Toggle'), "data-tooltip": getTitle() }, props, { success: registered, warning: networkStatus === 'offline', onClick: onClickVoipButton })));
};
exports.OmnichannelCallToggleReady = OmnichannelCallToggleReady;
