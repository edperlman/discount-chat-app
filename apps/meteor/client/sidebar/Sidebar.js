...
const OmnichannelSection_1 = __importDefault(require("./sections/OmnichannelSection"));
...
const Sidebar = () => {
    ...
    const sidebarLink = (0, css_in_js_1.css) `
		a {
			text-decoration: none;
		}
	`;
    return ((0, jsx_runtime_1.jsxs)(fuselage_1.Box, { display: 'flex', flexDirection: 'column', height: '100%', is: 'nav', className: [
            'rcx-sidebar--main',
            `rcx-sidebar rcx-sidebar--${sidebarViewMode}`,
            sidebarHideAvatar && 'rcx-sidebar--hide-avatar',
            sidebarLink,
        ].filter(Boolean), "data-qa-opened": sidebar.isCollapsed ? 'false' : 'true', children: [(0, jsx_runtime_1.jsx)(header_1.default, {}), (0, jsx_runtime_1.jsx)(BannerSection_1.default, {}), showOmnichannel && (0, jsx_runtime_1.jsx)(OmnichannelSection_1.default, {}), (0, jsx_runtime_1.jsx)(RoomList_1.default, {}), (0, jsx_runtime_1.jsx)(footer_1.default, {})] }));
};
