...
const CreateChannelModal = ({ teamId = '', mainRoom, onClose, reload }) => {
    var _a, _b;
    ...
    const canCreateTeamChannel = (0, ui_contexts_1.usePermission)('create-team-channel', mainRoom === null || mainRoom === void 0 ? void 0 : mainRoom._id);
    const canCreateTeamGroup = (0, ui_contexts_1.usePermission)('create-team-group', mainRoom === null || mainRoom === void 0 ? void 0 : mainRoom._id);
