...
const CreateTeam_1 = __importDefault(require("../../CreateTeam"));
...
const useCreateRoomItems = () => {
    ...
    const createChannel = (0, useCreateRoomModal_1.useCreateRoomModal)(CreateChannel_1.default);
    const createTeam = (0, useCreateRoomModal_1.useCreateRoomModal)(CreateTeam_1.default);
