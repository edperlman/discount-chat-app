...
const MatrixFederationSearchModalContent = ({ defaultSelectedServer, servers }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(fuselage_1.Box, { display: 'flex', flexDirection: 'row', children: [(0, jsx_runtime_1.jsx)(fuselage_1.Box, { mie: 4, flexGrow: 0, flexShrink: 4, children: (0, jsx_runtime_1.jsx)(fuselage_1.Select, { options: serverOptions, value: serverName, onChange: (value) => setServerName(String(value)) }) }), (0, jsx_runtime_1.jsx)(fuselage_1.SearchInput, { "aria-label": t('Search_rooms'), placeholder: t('Search_rooms'), flexGrow: 4, flexShrink: 0, value: roomName, onChange: (e) => setRoomName(e.currentTarget.value) })] }), (0, jsx_runtime_1.jsx)(fuselage_1.Box, { is: 'a', role: 'button', display: 'flex', flexDirection: 'row', mbe: 16, onClick: manageServers, children: t('Manage_server_list') }), (0, jsx_runtime_1.jsx)(FederatedRoomListErrorBoundary_1.default, { children: (0, jsx_runtime_1.jsx)(FederatedRoomList_1.default, { serverName: serverName, roomName: debouncedRoomName }) })] }));
};
