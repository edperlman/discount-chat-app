...
const useAccountItems = () => {
    ...
    const handleMyAccount = (0, fuselage_hooks_1.useEffectEvent)(() => {
        router.navigate('/account');
    });
    const handlePreferences = (0, fuselage_hooks_1.useEffectEvent)(() => {
        router.navigate('/account/preferences');
    });
    const handleFeaturePreview = (0, fuselage_hooks_1.useEffectEvent)(() => {
        router.navigate('/account/feature-preview');
    });
    const handleAccessibility = (0, fuselage_hooks_1.useEffectEvent)(() => {
