...
const NavBarItemOmnichannelLivechatToggle = (props) => {
    ...
    const handleAvailableStatusChange = (0, fuselage_hooks_1.useEffectEvent)(() => __awaiter(void 0, void 0, void 0, function* () {
        try {
...
exports.default = NavBarItemOmnichannelLivechatToggle;
