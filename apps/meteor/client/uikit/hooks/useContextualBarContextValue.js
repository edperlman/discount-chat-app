...
exports.useContextualBarContextValue = void 0;
...
const useContextualBarContextValue = ({ view, values, updateValues, }) => {
    ...
    return Object.assign(Object.assign({ action: (_a) => __awaiter(void 0, [_a], void 0, function* ({ appId, viewId, actionId, dispatchActionConfig, blockId, value }) {
            if (!appId || !viewId) {
                return;
            }
        ...
        } }, view), { values, viewId: view.id });
};
exports.useContextualBarContextValue = useContextualBarContextValue;
