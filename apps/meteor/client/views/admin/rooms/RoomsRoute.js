...
const RoomsPage_1 = __importDefault(require("./RoomsPage"));
const NotAuthorizedPage_1 = __importDefault(require("../../notAuthorized/NotAuthorizedPage"));
const RoomsRoute = () => {
    const canViewRoomAdministration = (0, ui_contexts_1.usePermission)('view-room-administration');
    if (!canViewRoomAdministration) {
        return (0, jsx_runtime_1.jsx)(NotAuthorizedPage_1.default, {});
    }
    return (0, jsx_runtime_1.jsx)(RoomsPage_1.default, {});
};
