...
const NavBarV2_1 = __importDefault(require("../../../NavBarV2"));
const sidebarv2_1 = __importDefault(require("../../../sidebarv2"));
const LayoutWithSidebarV2 = ({ children }) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        router.navigate({ name: `/channel/${firstChannelAfterLogin}` });
    }, [router, currentRoutePath, firstChannelAfterLogin]);
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(AccessibilityShortcut_1.default, {}), (0, jsx_runtime_1.jsx)(NavBarV2_1.default, {}), (0, jsx_runtime_1.jsxs)(fuselage_1.Box, { bg: 'surface-light', id: 'rocket-chat', className: [embeddedLayout ? 'embedded-view' : undefined, 'menu-nav'].filter(Boolean).join(' '), "aria-hidden": Boolean(modal), children: [(0, jsx_runtime_1.jsx)(MainLayoutStyleTags_1.MainLayoutStyleTags, {}), !removeSidenav && (0, jsx_runtime_1.jsx)(sidebarv2_1.default, {}), (0, jsx_runtime_1.jsx)("main", { id: 'main-content', className: ['main-content', readReceiptsEnabled ? 'read-receipts-enabled' : undefined].filter(Boolean).join(' '), children: children })] })] }));
};
exports.default = LayoutWithSidebarV2;
