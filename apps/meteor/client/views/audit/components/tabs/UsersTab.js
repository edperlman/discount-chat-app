...
const UsersTab = ({ form: { control } }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(fuselage_1.Field, { flexShrink: 1, children: [(0, jsx_runtime_1.jsx)(fuselage_1.FieldLabel, { children: t('Users') }), (0, jsx_runtime_1.jsx)(fuselage_1.FieldRow, { children: (0, jsx_runtime_1.jsx)(UserAutoCompleteMultiple_1.default, { error: !!usersFieldState.error, value: usersField.value, onChange: usersField.onChange, placeholder: t('Username_Placeholder') }) }), ((_a = usersFieldState.error) === null || _a === void 0 ? void 0 : _a.type) === 'required' && (0, jsx_runtime_1.jsx)(fuselage_1.FieldError, { children: t('Required_field', { field: t('Users') }) }), ((_b = usersFieldState.error) === null || _b === void 0 ? void 0 : _b.type) === 'validate' && (0, jsx_runtime_1.jsx)(fuselage_1.FieldError, { children: usersFieldState.error.message })] }));
};
