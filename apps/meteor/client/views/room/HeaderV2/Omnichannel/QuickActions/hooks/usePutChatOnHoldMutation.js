...
exports.usePutChatOnHoldMutation = void 0;
const ui_contexts_1 = require("@rocket.chat/ui-contexts");
const react_query_1 = require("@tanstack/react-query");
const queryKeys_1 = require("../../../../../../lib/queryKeys");
const usePutChatOnHoldMutation = (options) => {
    const putChatOnHold = (0, ui_contexts_1.useEndpoint)('POST', '/v1/livechat/room.onHold');
    const queryClient = (0, react_query_1.useQueryClient)();
    return (0, react_query_1.useMutation)((rid) => __awaiter(void 0, void 0, void 0, function* () {
        yield putChatOnHold({ roomId: rid });
...
exports.usePutChatOnHoldMutation = usePutChatOnHoldMutation;
