...
const RoomAnnouncement_1 = __importDefault(require("../RoomAnnouncement"));
...
const RoomTopic_1 = require("./RoomTopic");
...
const useBannerSection_1 = require("./hooks/useBannerSection");
...
const RoomBody = () => {
    ...
    const { wrapperRef: sectionWrapperRef, hideSection, innerRef: sectionScrollRef } = (0, useBannerSection_1.useBannerSection)();
    ...
    const innerRef = (0, fuselage_hooks_1.useMergedRefs)(dateScrollInnerRef, innerBoxRef, restoreScrollPositionInnerRef, isAtBottomInnerRef, newMessagesScrollRef, sectionScrollRef, unreadBarInnerRef, getMoreInnerRef, messageListRef);
    const wrapperBoxRefs = (0, fuselage_hooks_1.useMergedRefs)(unreadBarWrapperRef);
	...
	`;
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(fuselage_1.Box, { position: 'relative', w: 'full', children: (0, jsx_runtime_1.jsxs)(fuselage_1.Box, { animated: true, className: [wrapperStyle, hideSection && 'animated-hidden'].filter(isTruthy_1.isTruthy), ref: sectionWrapperRef, children: [(0, jsx_runtime_1.jsx)(RoomTopic_1.RoomTopic, { room: room, user: user }), !isLayoutEmbedded && room.announcement && (0, jsx_runtime_1.jsx)(RoomAnnouncement_1.default, { announcement: room.announcement, announcementDetails: undefined })] }) }), (0, jsx_runtime_1.jsx)(fuselage_1.Box, { className: ['main-content-flex', listStyle], children: (0, jsx_runtime_1.jsx)("section", { role: 'presentation', className: `messages-container flex-tab-main-content ${admin ? 'admin' : ''}`, id: `chat-window-${room._id}`, onClick: hideFlexTab && handleCloseFlexTab, children: (0, jsx_runtime_1.jsx)("div", { className: 'messages-container-wrapper', children: (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: 'messages-container-main', ref: wrapperBoxRefs }, fileUploadTriggerProps, { children: [(0, jsx_runtime_1.jsx)(DropTargetOverlay_1.default, Object.assign({}, fileUploadOverlayProps)), (0, jsx_runtime_1.jsxs)(fuselage_1.Box, { position: 'absolute', w: 'full', children: [(0, jsx_runtime_1.jsx)("div", { className: ['container-bars', uploads.length && 'show'].filter(isTruthy_1.isTruthy).join(' '), children: uploads.map((upload) => ((0, jsx_runtime_1.jsx)(UploadProgressIndicator_1.default, { id: upload.id, name: upload.name, percentage: upload.percentage, error: upload.error instanceof Error ? upload.error.message : undefined, onClose: handleUploadProgressClose }, upload.id))) }), Boolean(unread) && ((0, jsx_runtime_1.jsx)(UnreadMessagesIndicator_1.default, { count: unread, onJumpButtonClick: handleUnreadBarJumpToButtonClick, onMarkAsReadButtonClick: handleMarkAsReadButtonClick })), (0, jsx_runtime_1.jsx)(BubbleDate_1.BubbleDate, Object.assign({ ref: bubbleRef }, bubbleDate))] }), (0, jsx_runtime_1.jsxs)("div", { className: ['messages-box'].filter(isTruthy_1.isTruthy).join(' '), children: [(0, jsx_runtime_1.jsx)(JumpToRecentMessageButton_1.default, { visible: hasNewMessages, onClick: handleNewMessageButtonClick, text: t('New_messages') }), (0, jsx_runtime_1.jsx)(JumpToRecentMessageButton_1.default, { visible: hasMoreNextMessages, onClick: handleJumpToRecentButtonClick, text: t('Jump_to_recent_messages') }), !canPreview ? ((0, jsx_runtime_1.jsx)("div", { className: 'content room-not-found error-color', children: (0, jsx_runtime_1.jsx)("div", { children: t('You_must_join_to_view_messages_in_this_channel') }) })) : null, (0, jsx_runtime_1.jsx)("div", { className: [
                                                'wrapper',
