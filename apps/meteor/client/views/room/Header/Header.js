...
const DirectRoomHeader = (0, react_1.lazy)(() => Promise.resolve().then(() => __importStar(require('./DirectRoomHeader'))));
...
const Header = ({ room }) => {
    ...
    if (shouldDisplayE2EESetup) {
        return (0, jsx_runtime_1.jsx)(RoomHeaderE2EESetup, { room: room, topic: room.topic, slots: slots });
    }
    if ((0, core_typings_1.isDirectMessageRoom)(room) && ((_b = (_a = room.uids) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) < 3) {
        return (0, jsx_runtime_1.jsx)(DirectRoomHeader, { slots: slots, room: room });
    }
    return (0, jsx_runtime_1.jsx)(RoomHeader, { room: room, topic: room.topic, slots: slots });
};
