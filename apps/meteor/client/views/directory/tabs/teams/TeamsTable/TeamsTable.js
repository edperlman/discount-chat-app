...
const TeamsTableRow_1 = __importDefault(require("./TeamsTableRow"));
...
const TeamsTable = () => {
    ...
    const headers = (0, react_1.useMemo)(() => [
        ...
        (0, jsx_runtime_1.jsx)(GenericTable_1.GenericTableHeaderCell, { w: '100px', children: t('Channels') }, 'channelsCount'),
    ...
    ].filter(Boolean), [setSort, sortBy, sortDirection, t, mediaQuery]);
    const channelsRoute = (0, ui_contexts_1.useRoute)('channel');
    const groupsRoute = (0, ui_contexts_1.useRoute)('group');
    const getDirectoryData = (0, ui_contexts_1.useEndpoint)('GET', '/v1/directory');
    const query = (0, useDirectoryQuery_1.useDirectoryQuery)({ text, current, itemsPerPage }, [sortBy, sortDirection], 'teams');
