...
const ContactHistoryMessage_1 = __importDefault(require("./ContactHistoryMessage"));
const useHistoryMessageList_1 = require("./useHistoryMessageList");
...
const ContactHistoryMessagesList = ({ chatId, onClose, onOpenRoom }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(Contextualbar_1.ContextualbarHeader, { children: [(0, jsx_runtime_1.jsx)(Contextualbar_1.ContextualbarIcon, { name: 'history' }), (0, jsx_runtime_1.jsx)(Contextualbar_1.ContextualbarTitle, { children: t('Conversation') }), (0, jsx_runtime_1.jsx)(Contextualbar_1.ContextualbarClose, { onClick: onClose })] }), (0, jsx_runtime_1.jsxs)(Contextualbar_1.ContextualbarContent, { paddingInline: 0, children: [(0, jsx_runtime_1.jsx)(fuselage_1.Box, { display: 'flex', flexDirection: 'row', p: 24, borderBlockEndWidth: 'default', borderBlockEndStyle: 'solid', borderBlockEndColor: 'extra-light', flexShrink: 0, children: (0, jsx_runtime_1.jsx)(fuselage_1.Box, { display: 'flex', flexDirection: 'row', flexGrow: 1, mi: 'neg-x4', children: (0, jsx_runtime_1.jsx)(fuselage_1.Margins, { inline: 4, children: (0, jsx_runtime_1.jsx)(fuselage_1.TextInput, { placeholder: t('Search'), value: text, onChange: handleSearchChange, addon: (0, jsx_runtime_1.jsx)(fuselage_1.Icon, { name: 'magnifier', size: 'x20' }) }) }) }) }), phase === asyncState_1.AsyncStatePhase.LOADING && ((0, jsx_runtime_1.jsx)(fuselage_1.Box, { pi: 24, pb: 12, children: (0, jsx_runtime_1.jsx)(fuselage_1.Throbber, { size: 'x12' }) })), error && ((0, jsx_runtime_1.jsxs)(fuselage_1.States, { children: [(0, jsx_runtime_1.jsx)(fuselage_1.StatesIcon, { name: 'warning', variation: 'danger' }), (0, jsx_runtime_1.jsx)(fuselage_1.StatesTitle, { children: t('Something_went_wrong') }), (0, jsx_runtime_1.jsx)(fuselage_1.StatesSubtitle, { children: error.toString() })] })), phase !== asyncState_1.AsyncStatePhase.LOADING && totalItemCount === 0 && (0, jsx_runtime_1.jsx)(Contextualbar_1.ContextualbarEmptyContent, { title: t('No_results_found') }), (0, jsx_runtime_1.jsx)(fuselage_1.Box, { flexGrow: 1, flexShrink: 1, overflow: 'hidden', display: 'flex', ref: ref, children: !error && totalItemCount > 0 && history.length > 0 && ((0, jsx_runtime_1.jsx)(react_virtuoso_1.Virtuoso, { totalCount: totalItemCount, initialTopMostItemIndex: { index: 'LAST' }, followOutput: true, style: {
                                height: blockSize,
                                width: inlineSize,
...
exports.default = ContactHistoryMessagesList;
