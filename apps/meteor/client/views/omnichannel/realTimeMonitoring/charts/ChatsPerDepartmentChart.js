...
const init = (canvas, context, t) => (0, chartHandler_1.drawLineChart)(canvas, context, [t('Open'), t('Closed')], [], [[], []], {
    legends: true,
    anim: true,
    smallTicks: true,
});
const ChatsPerDepartmentChart = (_a) => {
    ...
    const { value: data = {}, phase: state, reload, } = (0, useEndpointData_1.useEndpointData)('/v1/livechat/analytics/dashboards/charts/chats-per-department', { params });
...
exports.default = ChatsPerDepartmentChart;
