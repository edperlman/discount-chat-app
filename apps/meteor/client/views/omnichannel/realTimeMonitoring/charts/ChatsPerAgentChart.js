...
const init = (canvas, context, t) => (0, chartHandler_1.drawLineChart)(canvas, context, [t('Open'), t('Closed'), t('On_Hold_Chats')], [], [[], []], {
    legends: true,
    anim: true,
    smallTicks: true,
});
const ChatsPerAgentChart = (_a) => {
    ...
    const { value: data = {}, phase: state, reload, } = (0, useEndpointData_1.useEndpointData)('/v1/livechat/analytics/dashboards/charts/chats-per-agent', { params });
...
exports.default = ChatsPerAgentChart;
