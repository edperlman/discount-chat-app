...
const init = (canvas, context, t) => (0, chartHandler_1.drawLineChart)(canvas, context, [t('Avg_reaction_time'), t('Longest_reaction_time'), t('Avg_response_time'), t('Longest_response_time')], labels, [initialData, initialData.slice(), initialData.slice(), initialData.slice()], { legends: true, anim: true, smallTicks: true, displayColors: false, tooltipCallbacks });
const ResponseTimesChart = (_a) => {
    ...
    const { reaction: { avg: reactionAvg, longest: reactionLongest }, response: { avg: responseAvg, longest: responseLongest }, } = data !== null && data !== void 0 ? data : {
        reaction: {
            avg: 0,
            longest: 0,
        },
...
exports.default = ResponseTimesChart;
