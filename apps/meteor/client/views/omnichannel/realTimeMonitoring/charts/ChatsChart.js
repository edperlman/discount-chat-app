...
const init = (canvas, context, t) => (0, chartHandler_1.drawDoughnutChart)(canvas, t('Chats'), context, labels.map((l) => t(l)), Object.values(initialData));
const ChatsChart = (_a) => {
    ...
    const { value: data, phase: state, reload } = (0, useEndpointData_1.useEndpointData)('/v1/livechat/analytics/dashboards/charts/chats', { params });
    reloadRef.current.chatsChart = reload;
    const { open, queued, closed, onhold } = data !== null && data !== void 0 ? data : initialData;
    (0, react_1.useEffect)(() => {
