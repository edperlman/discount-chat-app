...
const AgentsOverview = (_a) => {
    var { params, reloadRef } = _a, props = __rest(_a, ["params", "reloadRef"]);
    const { value: data, phase: state, reload, } = (0, useEndpointData_1.useEndpointData)('/v1/livechat/analytics/dashboards/agents-productivity-totalizers', { params });
...
exports.default = AgentsOverview;
