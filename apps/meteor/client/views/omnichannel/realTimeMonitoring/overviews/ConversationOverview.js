...
const ConversationOverview = (_a) => {
    var { params, reloadRef } = _a, props = __rest(_a, ["params", "reloadRef"]);
    const { value: data, phase: state, reload } = (0, useEndpointData_1.useEndpointData)('/v1/livechat/analytics/dashboards/conversation-totalizers', { params });
...
exports.default = ConversationOverview;
