...
const useSlaInfo_1 = require("../hooks/useSlaInfo");
const SlaField = ({ id }) => {
    const { t } = (0, react_i18next_1.useTranslation)();
    const { data, isInitialLoading, isError } = (0, useSlaInfo_1.useSlaInfo)(id);
    if (isInitialLoading) {
    ...
    const { name } = data;
    return ((0, jsx_runtime_1.jsxs)(Field_1.default, { children: [(0, jsx_runtime_1.jsx)(Label_1.default, { children: t('SLA_Policy') }), (0, jsx_runtime_1.jsx)(Info_1.default, { children: name })] }));
};
exports.default = SlaField;
