...
const AddAgent = ({ reload }) => {
    const { t } = (0, react_i18next_1.useTranslation)();
    const [username, setUsername] = (0, react_1.useState)('');
    const dispatchToastMessage = (0, ui_contexts_1.useToastMessageDispatch)();
    const saveAction = (0, useEndpointAction_1.useEndpointAction)('POST', '/v1/livechat/users/agent');
    ...
    return ((0, jsx_runtime_1.jsx)(fuselage_1.Box, { display: 'flex', alignItems: 'center', children: (0, jsx_runtime_1.jsxs)(fuselage_1.Field, { children: [(0, jsx_runtime_1.jsx)(fuselage_1.FieldLabel, { children: t('Username') }), (0, jsx_runtime_1.jsxs)(fuselage_1.FieldRow, { children: [(0, jsx_runtime_1.jsx)(ui_client_1.UserAutoComplete, { value: username, onChange: handleChange }), (0, jsx_runtime_1.jsx)(fuselage_1.Button, { disabled: !username, onClick: handleSave, mis: 8, primary: true, children: t('Add_agent') })] })] }) }));
};
