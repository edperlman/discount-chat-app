...
class AppEmailBridge extends bridges_1.EmailBridge {
    ...
    sendEmail(email, appId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Mailer.send(Object.assign(Object.assign({}, email), { from }));
        });
    }
}
exports.AppEmailBridge = AppEmailBridge;
