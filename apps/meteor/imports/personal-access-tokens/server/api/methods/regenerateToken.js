...
meteor_1.Meteor.methods({
    'personalAccessTokens:regenerateToken': (0, twoFactorRequired_1.twoFactorRequired)(function (_a) {
        return __awaiter(this, arguments, void 0, function* ({ tokenName }) {
            ...
            yield meteor_1.Meteor.callAsync('personalAccessTokens:removeToken', { tokenName });
            return meteor_1.Meteor.callAsync('personalAccessTokens:generateToken', {
                tokenName,
