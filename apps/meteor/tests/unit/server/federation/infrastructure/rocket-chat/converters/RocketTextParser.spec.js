...
const to_external_parser_formatter_1 = require("../../../../../../../server/services/federation/infrastructure/rocket-chat/converters/to-external-parser-formatter");
describe('Federation - Infrastructure - Matrix - RocketTextParser', () => {
    describe('#toInternalMessageFormat ()', () => {
        it('should parse the user mention correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
        ...
        it('should parse the mentions correctly when there is some room mention in RC format', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: "hello @marcos.defendi:tests-b.fed.rocket.chat, here's from Server A, @all, @marcos.defendi:tests-b.fed.rocket.chat",
                formattedMessage: '<p>hello <a href="https://matrix.to/#/@marcos.defendi:tests-b.fed.rocket.chat">@marcos.defendi:tests-b.fed.rocket.chat</a>, here&#39;s from Server A, <a href="https://matrix.to/#/!nAWjvnrjAoUWVMpqTy:tests-b.fed.rocket.chat">!nAWjvnrjAoUWVMpqTy:tests-b.fed.rocket.chat</a>, <a href="https://matrix.to/#/@marcos.defendi:tests-b.fed.rocket.chat">@marcos.defendi:tests-b.fed.rocket.chat</a></p>',
                homeServerDomain: 'localDomain',
                senderExternalId: '@user:externalDomain.com',
            })).to.be.equal("hello @marcos.defendi:tests-b.fed.rocket.chat, here's from Server A, @all, @marcos.defendi:tests-b.fed.rocket.chat");
        }));
        it('should parse the mentions correctly when there is some room mention in Element format', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: "hello marcos.defendi, here's from Server A, #test-thread:matrix.org, marcos.defendi",
                formattedMessage: 'hello <a href="https://matrix.to/#/@marcos.defendi:tests-b.fed.rocket.chat">marcos.defendi</a>, here\'s from Server A, <a href="https://matrix.to/#/#test-thread:matrix.org">#test-thread:matrix.org</a>, <a href="https://matrix.to/#/@marcos.defendi:tests-b.fed.rocket.chat">marcos.defendi</a>',
                homeServerDomain: 'localDomain',
                senderExternalId: '@user:externalDomain.com',
            })).to.be.equal("hello @marcos.defendi:tests-b.fed.rocket.chat, here's from Server A, @all, @marcos.defendi:tests-b.fed.rocket.chat");
        }));
        it('should parse the user mention correctly when using the RC format', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: '@user:localDomain.com @user',
                formattedMessage: '<a href="https://matrix.to/#/@user:localDomain.com">@user:localDomain.com</a> <a href="https://matrix.to/#/@user:externalDomain.com">@user:externalDomain.com</a>',
                homeServerDomain: 'localDomain.com',
                senderExternalId: '@user:externalDomain.com',
            })).to.be.equal('@user @user:externalDomain.com');
        }));
        it('should parse the user multiple mentions correctly when using the RC format', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: '@user @user:localDomain.com @user @user:localDomain.com',
                formattedMessage: '<a href="https://matrix.to/#/@user:externalDomain.com">@user:externalDomain.com</a> <a href="https://matrix.to/#/@user:localDomain.com">@user:localDomain.com</a> <a href="https://matrix.to/#/@user:externalDomain.com">@user:externalDomain.com</a> <a href="https://matrix.to/#/@user:localDomain.com">@user:localDomain.com</a>',
                homeServerDomain: 'localDomain.com',
                senderExternalId: '@user:externalDomain.com',
        ...
        it('should parse the @user mention without to include the server name when the user is original from the local ', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: 'hey User Real Name',
        ...
        it('should parse the message with all the mentions correctly when an user has the same real name', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                ...
                formattedMessage: '<p>hey <a href="https://matrix.to/#/@user:localDomain.com">User Real Name</a>, hey <a href="https://matrix.to/#/@remoteuser1:matrix.org">Remote User Real Name</a>,  hey <a href="https://matrix.to/#/@remoteuser2:matrix.org">Remote User Real Name</a> how are you? Hope <strong>you</strong> <strong>are</strong> doing well',
                homeServerDomain: 'localDomain.com',
                senderExternalId: '@user:externalDomain.com',
            ...
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: `hey User Real Name, how are you? Hope **you** __are__ doing well, please see the list:
					...
					**Ordered List** 
					...
					3. List Item 
					4. List Item`,
                formattedMessage: '<p>hey <a href="https://matrix.to/#/@user:localDomain.com">User Real Name</a>, how are you? Hope <strong>you</strong> <strong>are</strong> doing well, please see the list: # List 1: <strong>Ordered List</strong> </p> <pre><code> 1. List Item 2. List Item 3. List Item 4. List Item </code></pre>',
                homeServerDomain: 'localDomain.com',
                senderExternalId: '@user:externalDomain.com',
            ...
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: `hey, here its Remote User Real Name, how are you? Hope **you** __are__ doing well, please see the list:
					...
					**Ordered List** 
					...
					3. List Item 
					4. List Item`,
                formattedMessage: '<p>hey, here its <a href="https://matrix.to/#/@remoteuser:matrix.org">Remote User Real Name</a>, how are you? Hope <strong>you</strong> <strong>are</strong> doing well, please see the list: # List 1: <strong>Ordered List</strong> </p> <pre><code> 1. List Item 2. List Item 3. List Item 4. List Item </code></pre>',
                homeServerDomain: 'localDomain.com',
                senderExternalId: '@user:externalDomain.com',
        ...
        it('should parse correctly a message containing mentions for the user himself + external mentions', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
        ...
        it('should parse correctly a message containing both mentions', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalMessageFormat)({
                rawMessage: `@user, @user:matrix.org`,
                formattedMessage: '<p><a href="https://matrix.to/#/@user:externalDomain.com">@user:externalDomain.com</a>, <a href="https://matrix.to/#/@user:matrix.org">@user:matrix.org</a>',
                homeServerDomain: 'localDomain.com',
                senderExternalId: '@user:externalDomain.com',
    ...
    describe('#toInternalQuoteMessageFormat ()', () => {
        ...
        it('should parse the external quote to the internal one correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalQuoteMessageFormat)({
                homeServerDomain,
                rawMessage,
                formattedMessage,
        ...
        it('should parse the nested quotes correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const rawMessage = '> <@marcos.defendi:tests-a.fed.rocket.chat>\n> test\nhello nested quote';
            const nested = '<mx-reply><blockquote><a href="https://matrix.to/#/externalRoomId/eventToReplyToId">In reply to</a> <a href="https://matrix.to/#/originalEventSender">originalEventSender</a><br>test</blockquote></mx-reply>hello nested quote';
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalQuoteMessageFormat)({
                homeServerDomain,
                rawMessage,
        ...
        it('should parse the message with all the mentions correctly when an user has the same real name', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(yield (0, to_external_parser_formatter_1.toInternalQuoteMessageFormat)({
                ...
                messageToReplyToUrl: 'http://localhost:3000/group/1?msg=2354543564',
                senderExternalId: '@user:externalDomain.com',
            })).to.be.equal(`[ ](http://localhost:3000/group/1?msg=2354543564) hey @user, hey @remoteuser1:matrix.org, hey @remoteuser2:matrix.org, how are you? Hope **you** __are__ doing well`);
        }));
        it('should parse correctly a message containing both local mentions + some markdown', () => __awaiter(void 0, void 0, void 0, function* () {
