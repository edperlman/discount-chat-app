...
exports.privateKeyCert = exports.privateKey = exports.certificate = exports.profile = exports.encryptedResponse = exports.duplicatedSamlResponse = exports.samlResponse = exports.samlResponseValidAssertionSignature = exports.samlResponseValidSignatures = exports.samlResponseMultipleIssuers = exports.samlResponseMultipleAssertions = exports.samlResponseFailedStatus = exports.samlResponseMissingAssertion = exports.samlResponseMissingStatus = exports.simpleSamlResponse = exports.invalidLogoutResponse = exports.simpleLogoutResponse = exports.invalidLogoutRequest = exports.simpleLogoutRequest = exports.randomXml = exports.invalidXml = exports.metadataWithCertificate = exports.simpleMetadata = exports.serviceProviderOptions = void 0;
exports.serviceProviderOptions = {
...
exports.simpleMetadata = `<?xml version="1.0"?>
...
exports.metadataWithCertificate = `<?xml version="1.0"?>
<EntityDescriptor xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:oasis:names:tc:SAML:2.0:metadata https://docs.oasis-open.org/security/saml/v2.0/saml-schema-metadata-2.0.xsd" xmlns="urn:oasis:names:tc:SAML:2.0:metadata" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" entityID="[issuer]">
  <SPSSODescriptor protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
    <KeyDescriptor>
      <ds:KeyInfo>
...
exports.invalidXml = 'not a xml file';
exports.randomXml = `<?xml version="1.0"?>
<Document>
	<Element Attribute="Value" />
	<AnotherElement>Value</AnotherElement>
</Document>`;
exports.simpleLogoutRequest = `<samlp:LogoutRequest xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" ID="_e9c0751f722b4506c667d634a7c28126cdbfa80118" Version="2.0" IssueInstant="[INSTANT]" Destination="http://localhost:3000/_saml/logout/test-sp/" NotOnOrAfter="[NotOnOrAfter]">
...
exports.invalidLogoutRequest = `<samlp:LogoutRequest xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" ID="_e9c0751f722b4506c667d634a7c28126cdbfa80118" Version="2.0" IssueInstant="[INSTANT]" Destination="http://localhost:3000/_saml/logout/test-sp/" NotOnOrAfter="[NotOnOrAfter]">
	<saml:Issuer>http://localhost:8080/simplesaml/saml2/idp/metadata.php</saml:Issuer>
	<samlp:SessionIndex>_d6ad0e25459aaddd0433a81e159aa79e55dc52c280</samlp:SessionIndex>
</samlp:LogoutRequest>`;
exports.simpleLogoutResponse = `<samlp:LogoutResponse xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" ID="_804853615e31dd9b2fb54a71faa09d95a370003574" Version="2.0" IssueInstant="[INSTANT]" Destination="http://localhost:3000/_saml/logout/test-sp/" InResponseTo="_id-6530db3fcd23dc42a31c">
	<saml:Issuer>[IssuerName]</saml:Issuer>
	<samlp:Status>
		<samlp:StatusCode Value="[STATUSCODE]"/>
	</samlp:Status>
</samlp:LogoutResponse>`;
exports.invalidLogoutResponse = `<samlp:LogoutResponse xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" ID="_804853615e31dd9b2fb54a71faa09d95a370003574" Version="2.0" IssueInstant="[INSTANT]" Destination="http://localhost:3000/_saml/logout/test-sp/" InResponseTo="_id-6530db3fcd23dc42a31c">
	<saml:Issuer>[IssuerName]</saml:Issuer>
</samlp:LogoutResponse>`;
...
exports.simpleSamlResponse = `${samlResponseHeader}
	${samlResponseIssuer}
	${samlResponseStatus}
	${samlResponseAssertion}
${samlResponseFooter}`;
exports.samlResponseMissingStatus = `${samlResponseHeader}
	${samlResponseIssuer}
	${samlResponseAssertion}
${samlResponseFooter}`;
exports.samlResponseMissingAssertion = `${samlResponseHeader}
	${samlResponseIssuer}
	${samlResponseStatus}
${samlResponseFooter}`;
exports.samlResponseFailedStatus = `${samlResponseHeader}
	${samlResponseIssuer}
	<samlp:Status>
	...
	${samlResponseAssertion}
${samlResponseFooter}`;
exports.samlResponseMultipleAssertions = `${samlResponseHeader}
	${samlResponseIssuer}
	${samlResponseStatus}
	${samlResponseAssertion}
	${samlResponseAssertion}
${samlResponseFooter}`;
exports.samlResponseMultipleIssuers = `${samlResponseHeader}
	${samlResponseIssuer}
	${samlResponseStatus}
...
exports.samlResponseValidAssertionSignature = `<samlp:Response xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" ID="_31dd75023c1537f1016f835db64c18fee89d9db561" Version="2.0" IssueInstant="2020-06-03T17:55:29Z" Destination="http://localhost:3000/_saml/validate/test-sp" InResponseTo="id-L9qm86X4eez8a75G4"><saml:Issuer>http://localhost:8080/simplesaml/saml2/idp/metadata.php</saml:Issuer><ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
  <ds:SignedInfo><ds:CanonicalizationMethod Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/>
    <ds:SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"/>
...
exports.certificate = `MIIDXTCCAkWgAwIBAgIJALmVVuDWu4NYMA0GCSqGSIb3DQEBCwUAMEUxCzAJBgNV
...
-----END PRIVATE KEY-----`;
exports.privateKeyCert = `-----BEGIN CERTIFICATE-----
