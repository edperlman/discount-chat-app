...
exports.HomeFlextabNotificationPreferences = void 0;
class HomeFlextabNotificationPreferences {
    constructor(page) {
        this.page = page;
    }
    get btnSave() {
...
exports.HomeFlextabNotificationPreferences = HomeFlextabNotificationPreferences;
