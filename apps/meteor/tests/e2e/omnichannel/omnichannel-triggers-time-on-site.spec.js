...
test_1.test.describe('OC - Livechat Triggers - Time on site', () => {
    let poLiveChat;
    let newVisitor;
    let agent;
    ...
    (0, test_1.test)('expect to receive trigger message after 1 second', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, test_1.expect)(poLiveChat.page.locator('role=button[name="Close"]')).toBeVisible();
        yield (0, test_1.expect)(poLiveChat.page.locator('role=main')).toContainText('This is a trigger message time on site');
        yield (0, test_1.expect)(poLiveChat.page.locator('role=button[name="Start chat"]')).toBeVisible();
        yield (0, test_1.expect)(poLiveChat.page.locator('role=button[name="Messages"]')).toBeVisible();
    }));
    (0, test_1.test)('OC - Livechat Triggers - after the visitor opens the chat the trigger time-on-site should not be triggered after reload', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, test_1.expect)(poLiveChat.page.locator('role=button[name="Close"]')).toBeVisible();
        yield (0, test_1.expect)(poLiveChat.page.locator('role=main')).toContainText('This is a trigger message time on site');
        yield (0, test_1.expect)(poLiveChat.page.locator('role=button[name="Start chat"]')).toBeVisible();
        yield (0, test_1.expect)(poLiveChat.page.locator('role=button[name="Messages"]')).toBeVisible();
        yield poLiveChat.btnOpenOnlineLiveChat('Start chat').click();
        yield poLiveChat.btnOpenOnlineLiveChat('Chat now').click();
        yield poLiveChat.sendMessage(newVisitor, false);
        yield test_1.test.step('expect to not have any trigger message after registration', () => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, test_1.expect)(poLiveChat.txtChatMessage('This is a trigger message time on site')).not.toBeVisible();
        }));
        ...
        yield (0, test_1.expect)(poLiveChat.page.locator('role=main')).toContainText('Chat started');
        yield poLiveChat.page.reload();
        yield poLiveChat.btnOpenOnlineLiveChat('Rocket.Chat').click();
        yield (0, test_1.expect)(poLiveChat.page.locator('role=main')).toContainText('Chat started');
        yield poLiveChat.page.waitForTimeout(1000);
        yield (0, test_1.expect)(poLiveChat.txtChatMessage('This is a trigger message time on site')).not.toBeVisible();
    }));
});
