...
test_1.test.describe('Omnichannel Canned Responses Sidebar', () => {
    ...
    (0, test_1.test)('Receiving a message from visitor', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
        ...
        yield test_1.test.step('Expect to be able to open canned responses sidebar and creation', () => __awaiter(void 0, void 0, void 0, function* () {
            yield agent.poHomeChannel.content.btnCannedResponses.click();
            yield agent.poHomeChannel.content.btnNewCannedResponse.click();
        }));
    }));
});
