...
test_1.test.describe.parallel('Mention User Card [To Member]', () => {
    let poHomeChannel;
    let targetChannel;
    test_1.test.beforeAll((_a) => __awaiter(void 0, [_a], void 0, function* ({ api }) {
        targetChannel = yield (0, utils_1.createTargetChannel)(api, { members: [userStates_1.Users.user1.data.username, userStates_1.Users.user3.data.username] });
    ...
    (0, test_1.test)('should show correct userinfo actions for a member of the room to a non-privileged member', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    (0, test_1.test)('should show correct userinfo actions for a non-member of the room to a non-privileged member', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
        yield poHomeChannel.sidenav.openChat(targetChannel);
