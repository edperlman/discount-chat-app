...
test_1.test.describe.parallel('Federation - Group Messaging', () => {
    ...
    test_1.test.describe('Messaging - Group (Private)', () => {
        ...
        test_1.test.describe('Visual Elements', () => {
            (0, test_1.test)('expect to see the file list sent in the group on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(createdGroupName);
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnFileList).toBeVisible();
            }));
            (0, test_1.test)('expect to see the file list sent in the group on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(createdGroupName);
                yield (0, test_1.expect)(poFederationChannelServer2.tabs.btnFileList).toBeVisible();
            }));
            (0, test_1.test)('expect to see all the mentions sent in the group on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(createdGroupName);
            ...
            (0, test_1.test)('expect to see all the mentions sent in the group on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(createdGroupName);
            ...
            (0, test_1.test)('expect to see all the starred messages sent in the group on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(createdGroupName);
                yield poFederationChannelServer1.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnStarredMessagesList).toBeVisible();
            }));
            (0, test_1.test)('expect to see all the starred messages sent in the group on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(createdGroupName);
                yield poFederationChannelServer2.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer2.tabs.btnStarredMessagesList).toBeVisible();
            }));
            (0, test_1.test)('expect to not to see the pinned messages sent in the group on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(createdGroupName);
                yield poFederationChannelServer1.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnPinnedMessagesList).not.toBeVisible();
            }));
            (0, test_1.test)('expect to not to see the pinned messages sent in the group on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(createdGroupName);
                yield poFederationChannelServer2.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer2.tabs.btnPinnedMessagesList).not.toBeVisible();
            }));
            (0, test_1.test)('expect to not be able to prune messages sent in the group on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(createdGroupName);
                yield poFederationChannelServer1.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnPruneMessages).not.toBeVisible();
            }));
            (0, test_1.test)('expect to not be able to prune messages sent in the group on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(createdGroupName);
                yield poFederationChannelServer2.tabs.kebab.click();
