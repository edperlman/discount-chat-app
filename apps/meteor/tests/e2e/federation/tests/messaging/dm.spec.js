...
test_1.test.describe.parallel('Federation - DM Messaging', () => {
    ...
    test_1.test.describe('Messaging - Direct Messages (DMs)', () => {
        test_1.test.describe('Send message', () => {
            ...
            test_1.test.describe('With multiple users', () => {
                ...
                let usernameWithDomainFromServer2;
                (0, test_1.test)('expect to send a message from Server A (creator) to Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                    ...
                    usernameWithDomainFromServer2 = (0, format_1.formatUsernameAndDomainIntoMatrixFormat)(createdUsernameFromServer2, constants.RC_SERVER_2.matrixServerName);
                    ...
                    yield poFederationChannelServer2.sidenav.openDMMultipleChat(adminUsernameWithDomainFromServer1);
                ...
                (0, test_1.test)('expect to send a message from Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page, browser }) {
                    const page2 = yield browser.newPage();
                    const poFederationChannel1ForUser2 = new channel_1.FederationChannel(page2);
                    const pageForServer2 = yield browser.newPage();
                    const poFederationChannelServer2 = new channel_1.FederationChannel(pageForServer2);
        ...
        test_1.test.describe('Send "Special" messages', () => {
            ...
            (0, test_1.test)('expect to send a message mentioning an user Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                ...
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServer2.content.sendMessage('hello');
                yield poFederationChannelServer1.sidenav.openChat(usernameWithDomainFromServer2);
                yield poFederationChannelServer2.content.inputMessage.type(`@${constants.RC_SERVER_1.username}`, { delay: 100 });
                yield poFederationChannelServer2.content.messagePopUpItems
                    .locator(`role=listitem >> text="${adminUsernameWithDomainFromServer1}"`)
        ...
        test_1.test.describe('Message actions', () => {
            (0, test_1.test)('expect to send a message quoting a message from Server A to Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, apiServer2, page }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                ...
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield page2.goto(`${constants.RC_SERVER_2.url}/home`);
                ...
                yield poFederationChannelServerUser2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                ...
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.waitForLastMessageTextAttachmentEqualsText).toHaveText(message);
                yield page2.close();
            }));
            (0, test_1.test)('expect to send a message quoting a message Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, apiServer2, page }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield poFederationChannelServer1.content.sendMessageUsingEnter(message);
                yield poFederationChannelServerUser2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServerUser2.content.quoteMessage('this is a quote message');
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.waitForLastMessageTextAttachmentEqualsText).toHaveText(message);
                yield (0, test_1.expect)(poFederationChannelServer1.content.waitForLastMessageTextAttachmentEqualsText).toHaveText(message);
                yield page2.close();
            }));
            (0, test_1.test)('expect to react a message from Server A to Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                const reactionsServer2 = yield poFederationChannelServerUser2.content.getAllReactions();
            ...
            (0, test_1.test)('expect to react a message from Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield poFederationChannelServer1.content.sendMessageUsingEnter('message from Server A');
                yield poFederationChannelServerUser2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServerUser2.content.reactToMessage('slight_smile');
                const reactionsServer1 = yield poFederationChannelServer1.content.getAllReactions();
                const reactionListExcludingTheActionServer1 = (yield reactionsServer1.count()) - 1;
                for (let i = 0; i < reactionListExcludingTheActionServer1; i++) {
                    yield (0, test_1.expect)(reactionsServer1.nth(i).locator('span.rcx-message-reactions__emoji.emojione')).toContainText('🙂');
            ...
            (0, test_1.test)('expect to unreact a message from Server A to Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page, apiServer2 }) {
                yield poFederationChannelServer2.sidenav.logout();
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                    page: pageForServer2,
                    server: {
                ...
                yield pageForServer2.reload({ waitUntil: 'domcontentloaded' });
            ...
            (0, test_1.test)('expect to unreact a message from Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page, apiServer2 }) {
                yield poFederationChannelServer2.sidenav.logout();
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                    page: pageForServer2,
            ...
            (0, test_1.test)('expect to edit a message from Server A to Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server A');
                ...
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server A - Edited');
                yield page2.close();
            }));
            (0, test_1.test)('expect to edit a message from Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield poFederationChannelServer1.content.sendMessage('message');
                yield poFederationChannelServerUser2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServerUser2.content.sendMessageUsingEnter('message from Server B');
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server B');
                yield (0, test_1.expect)(poFederationChannelServer1.content.lastUserMessageBody).toHaveText('message from Server B');
                yield poFederationChannelServerUser2.content.editLastMessage('message from Server B - Edited');
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server B - Edited');
                yield (0, test_1.expect)(poFederationChannelServer1.content.lastUserMessageBody).toHaveText('message from Server B - Edited');
                yield page2.close();
            }));
            (0, test_1.test)('expect to delete a message from Server A to Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessage).not.toBeVisible();
                yield page2.close();
            }));
            (0, test_1.test)('expect to delete a message from Server B to Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield poFederationChannelServerUser2.content.sendMessageUsingEnter('message from Server B');
                yield poFederationChannelServerUser2.content.deleteLastMessage();
                yield (0, test_1.expect)(poFederationChannelServerUser2.toastSuccess).toBeVisible();
                yield (0, test_1.expect)(poFederationChannelServer1.content.lastUserMessage).not.toBeVisible();
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessage).not.toBeVisible();
                yield page2.close();
            }));
            (0, test_1.test)('expect to star a message on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
            ...
            (0, test_1.test)('expect to star a message on Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield poFederationChannelServer1.content.sendMessage('message');
                yield poFederationChannelServerUser2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServerUser2.content.sendMessageUsingEnter('message from Server A');
                yield (0, test_1.expect)(poFederationChannelServer1.content.lastUserMessageBody).toHaveText('message from Server A');
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server A');
                yield poFederationChannelServerUser2.content.starLastMessage();
                yield (0, test_1.expect)(poFederationChannelServerUser2.toastSuccess.locator('div.rcx-toastbar-content', { hasText: 'Message has been starred' })).toBeVisible();
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessage.locator('.rcx-icon--name-star-filled')).toBeVisible();
                yield page2.close();
            }));
            (0, test_1.test)('expect to not be able to start a discussion from a message in Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
            ...
            (0, test_1.test)('expect to not be able to start a discussion from a message in Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield (0, test_1.expect)(poFederationChannelServer1.content.lastUserMessageBody).toHaveText('message from Server A');
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server A');
                yield poFederationChannelServerUser2.content.openLastMessageMenu();
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.btnOptionStartDiscussion).not.toBeVisible();
                yield page2.close();
            }));
            (0, test_1.test)('expect to not be able to pin a message in Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
            ...
            (0, test_1.test)('expect to not be able to pin a message in Server B', (_a) => __awaiter(void 0, [_a], void 0, function* ({ browser, page, apiServer2 }) {
                const page2 = yield browser.newPage();
                const poFederationChannelServerUser2 = new channel_1.FederationChannel(page2);
                const usernameFromServer2 = yield (0, register_user_1.registerUser)(apiServer2);
                yield (0, auth_1.doLogin)({
                ...
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.lastUserMessageBody).toHaveText('message from Server A');
                yield poFederationChannelServerUser2.content.openLastMessageMenu();
                yield (0, test_1.expect)(poFederationChannelServerUser2.content.btnOptionPinMessage).not.toBeVisible();
                yield page2.close();
            }));
        });
        test_1.test.describe('Visual Elements', () => {
            (0, test_1.test)('expect to see the file list sent in the DM on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(usernameWithDomainFromServer2);
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnFileList).toBeVisible();
            }));
            (0, test_1.test)('expect to see the file list sent in the DM on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield (0, test_1.expect)(poFederationChannelServer2.tabs.btnFileList).toBeVisible();
            }));
            (0, test_1.test)('expect to see all the starred messages sent in the DM on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(usernameWithDomainFromServer2);
            ...
            (0, test_1.test)('expect to see all the starred messages sent in the DM on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(adminUsernameWithDomainFromServer1);
            ...
            (0, test_1.test)('expect to not to see the pinned messages sent in the DM on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(usernameWithDomainFromServer2);
                yield poFederationChannelServer1.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnPinnedMessagesList).not.toBeVisible();
            }));
            (0, test_1.test)('expect to not to see the pinned messages sent in the DM on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServer2.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer2.tabs.btnPinnedMessagesList).not.toBeVisible();
            }));
            (0, test_1.test)('expect to not be able to prune messages sent in the DM on Server A', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
                yield page.goto(`${constants.RC_SERVER_1.url}/home`);
                yield poFederationChannelServer1.sidenav.openChat(usernameWithDomainFromServer2);
                yield poFederationChannelServer1.tabs.kebab.click();
                yield (0, test_1.expect)(poFederationChannelServer1.tabs.btnPruneMessages).not.toBeVisible();
            }));
            (0, test_1.test)('expect to not be able to prune messages sent in the DM on Server B', () => __awaiter(void 0, void 0, void 0, function* () {
                yield pageForServer2.goto(`${constants.RC_SERVER_2.url}/home`);
                yield poFederationChannelServer2.sidenav.openChat(adminUsernameWithDomainFromServer1);
                yield poFederationChannelServer2.tabs.kebab.click();
