...
exports.useRegisterMethod = void 0;
const ui_contexts_1 = require("@rocket.chat/ui-contexts");
const react_query_1 = require("@tanstack/react-query");
const useRegisterMethod = () => {
    const register = (0, ui_contexts_1.useEndpoint)('POST', '/v1/users.register');
    const secret = (0, ui_contexts_1.useRouteParameter)('hash');
...
exports.useRegisterMethod = useRegisterMethod;
