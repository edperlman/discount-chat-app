...
class VoipClient extends emitter_1.Emitter {
    constructor(config, mediaRenderer) {
        ...
        this.call = (calleeURI, mediaRenderer) => __awaiter(this, void 0, void 0, function* () {
            ...
            const inviter = new sip_js_1.Inviter(this.userAgent, target, {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.userAgent = new sip_js_1.UserAgent({
                authorizationPassword: authPassword,
                authorizationUsername: authUserName,
                uri: sip_js_1.UserAgent.makeURI(`sip:${authUserName}@${sipRegistrarHostnameOrIP}`),
                transportOptions,
    ...
    initSession(session) {
        ...
        (_a = this.session) === null || _a === void 0 ? void 0 : _a.stateChange.addListener((state) => {
            ...
            const sessionEvents = {
                [sip_js_1.SessionState.Initial]: () => undefined, // noop
                [sip_js_1.SessionState.Establishing]: this.onSessionStablishing,
                [sip_js_1.SessionState.Established]: this.onSessionStablished,
                [sip_js_1.SessionState.Terminating]: this.onSessionTerminated,
                [sip_js_1.SessionState.Terminated]: this.onSessionTerminated,
            };
    ...
    getContactInfo() {
        ...
        if (!(this.session instanceof sip_js_1.Invitation) && !(this.session instanceof sip_js_1.Inviter)) {
            return null;
        }
    ...
    getReferredBy() {
        ...
        const uri = sip_js_1.UserAgent.makeURI(referredBy.slice(1, -1));
        if (!uri) {
            return null;
        }
        return {
    ...
    isRegistered() {
        var _a;
        return ((_a = this.registerer) === null || _a === void 0 ? void 0 : _a.state) === sip_js_1.RegistererState.Registered;
    }
    isReady() {
        var _a;
        return ((_a = this.userAgent) === null || _a === void 0 ? void 0 : _a.state) === sip_js_1.UserAgentState.Started;
    }
    isCaller() {
        return this.session instanceof sip_js_1.Inviter;
    }
    isCallee() {
        return this.session instanceof sip_js_1.Invitation;
    }
    isIncoming() {
    ...
    getSessionType() {
        ...
        if (((_a = this.session) === null || _a === void 0 ? void 0 : _a.state) === sip_js_1.SessionState.Established) {
            return 'ONGOING';
        }
        if (this.session instanceof sip_js_1.Invitation) {
            return 'INCOMING';
    ...
    setupRemoteMedia() {
        ...
        this.remoteStream = new RemoteStream_1.default(remoteMediaStream);
    ...
    makeURI(calleeURI) {
        ...
        return sip_js_1.UserAgent.makeURI(`sip:${hasPlusChar ? '*' : ''}${calleeURI}@${this.config.sipRegistrarHostnameOrIP}`);
    }
    ...
    updateContactInfoFromMessage(message) {
        ...
        try {
            ...
            const uri = sip_js_1.UserAgent.makeURI(data.uri);
            if (!uri) {
                throw new Error('Failed to parse contact update message');
            }
            this.setContactInfo({
