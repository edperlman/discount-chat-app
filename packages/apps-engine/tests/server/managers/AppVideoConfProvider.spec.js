...
let AppSlashCommandRegistrationTestFixture = (() => {
    ...
    let _ensureAppVideoConfManager_decorators;
    return _a = class AppSlashCommandRegistrationTestFixture {
            ...
            ensureAppVideoConfManager() {
                (0, alsatian_1.Expect)(() => new AppVideoConfProvider_1.AppVideoConfProvider(this.mockApp, {})).not.toThrow();
                const ascr = new AppVideoConfProvider_1.AppVideoConfProvider(this.mockApp, {});
        ...
        (() => {
            ...
            _ensureAppVideoConfManager_decorators = [(0, alsatian_1.Test)()];
            ...
            __esDecorate(_a, null, _ensureAppVideoConfManager_decorators, { kind: "method", name: "ensureAppVideoConfManager", static: false, private: false, access: { has: obj => "ensureAppVideoConfManager" in obj, get: obj => obj.ensureAppVideoConfManager }, metadata: _metadata }, null, _instanceExtraInitializers);
