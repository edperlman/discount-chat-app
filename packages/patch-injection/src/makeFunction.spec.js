...
describe('Make a simple function', () => {
    ...
    it('should return the result of the internal function', () => {
        const fn = (0, makeFunction_1.makeFunction)(() => 15);
        expect(fn()).toBe(15);
    });
});
...
describe('Chained calls', () => {
    ...
    it('should send the parameters in the correct order every time', () => {
        const fn = (0, makeFunction_1.makeFunction)((a, b) => `3=${[a, b].join('')}`);
...
describe('Multiple patches', () => {
    ...
    it('should chain on the right order', () => {
        const fn = (0, makeFunction_1.makeFunction)(() => [1]);
        let enabled2 = true;
        let enabled3 = true;
        let enabled4 = true;
        fn.patch((next) => [2].concat(next()), () => enabled2);
        const remove3 = fn.patch((next) => [3].concat(next()), () => enabled3);
        fn.patch((next) => [4].concat(next()), () => enabled4);
