...
const ToggleSwitchElement = ({ block, context, surfaceRenderer, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(fuselage_1.Box, { children: options.map((option) => {
            ...
            return ((0, jsx_runtime_1.jsxs)(fuselage_1.Box, { pb: 4, children: [(0, jsx_runtime_1.jsx)(fuselage_1.ToggleSwitch, { disabled: loading, value: option.value, checked: isChecked, onChange: action }), (0, jsx_runtime_1.jsx)(fuselage_1.Box, { is: 'label', pis: 8, children: surfaceRenderer.renderTextObject(option.text, 0, UiKit.BlockContext.NONE) })] }, option.value));
        }) }));
};
exports.default = ToggleSwitchElement;
