...
const DatePickerElement = ({ block, context, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(fuselage_1.InputBox, { type: 'date', error: error, value: value, disabled: loading, id: actionId, name: actionId, rows: 6, placeholder: fromTextObjectToString(placeholder), onInput: action }));
};
