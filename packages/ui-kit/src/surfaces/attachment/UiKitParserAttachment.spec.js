...
const UiKitParserAttachment_1 = require("./UiKitParserAttachment");
const uiKitAttachment_1 = require("./uiKitAttachment");
const BlockContext_1 = require("../../rendering/BlockContext");
class TestParser extends UiKitParserAttachment_1.UiKitParserAttachment {
    constructor() {
        super(...arguments);
...
const parse = (0, uiKitAttachment_1.uiKitAttachment)(parser);
const conditionalParse = (0, uiKitAttachment_1.uiKitAttachment)(parser, {
    engine: 'rocket.chat',
});
describe('divider', () => {
    it('renders', () => {
