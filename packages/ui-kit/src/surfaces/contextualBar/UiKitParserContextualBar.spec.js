...
const UiKitParserContextualBar_1 = require("./UiKitParserContextualBar");
const uiKitContextualBar_1 = require("./uiKitContextualBar");
const BlockContext_1 = require("../../rendering/BlockContext");
class TestParser extends UiKitParserContextualBar_1.UiKitParserContextualBar {
    constructor() {
        super(...arguments);
...
const parse = (0, uiKitContextualBar_1.uiKitContextualBar)(parser);
const conditionalParse = (0, uiKitContextualBar_1.uiKitContextualBar)(parser, {
    engine: 'rocket.chat',
});
describe('divider', () => {
    it('renders', () => {
