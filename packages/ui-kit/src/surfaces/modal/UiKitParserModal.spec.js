...
const UiKitParserModal_1 = require("./UiKitParserModal");
const uiKitModal_1 = require("./uiKitModal");
const BlockContext_1 = require("../../rendering/BlockContext");
class TestParser extends UiKitParserModal_1.UiKitParserModal {
    constructor() {
        super(...arguments);
...
const parse = (0, uiKitModal_1.uiKitModal)(parser);
const conditionalParse = (0, uiKitModal_1.uiKitModal)(parser, {
    engine: 'rocket.chat',
});
describe('divider', () => {
    it('renders', () => {
