...
const UiKitParserMessage_1 = require("./UiKitParserMessage");
const uiKitMessage_1 = require("./uiKitMessage");
const BlockContext_1 = require("../../rendering/BlockContext");
class TestParser extends UiKitParserMessage_1.UiKitParserMessage {
    constructor() {
        super(...arguments);
...
const parse = (0, uiKitMessage_1.uiKitMessage)(parser);
const conditionalParse = (0, uiKitMessage_1.uiKitMessage)(parser, {
    engine: 'rocket.chat',
});
describe('divider', () => {
    it('renders', () => {
