...
const BoldSpan = ({ children }) => ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: children.map((block, index) => {
        if (block.type === 'LINK' ||
            block.type === 'PLAIN_TEXT' ||
            block.type === 'STRIKE' ||
            block.type === 'ITALIC' ||
            block.type === 'INLINE_CODE') {
            return (0, jsx_runtime_1.jsx)("strong", { children: renderBlockComponent(block, index) }, index);
        }
