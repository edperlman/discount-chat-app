...
const ItalicSpan = ({ children }) => ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: children.map((block, index) => {
        if (block.type === 'LINK' ||
            block.type === 'PLAIN_TEXT' ||
            block.type === 'STRIKE' ||
            block.type === 'BOLD' ||
            block.type === 'INLINE_CODE') {
            return (0, jsx_runtime_1.jsx)("em", { children: renderBlockComponent(block, index) }, index);
        }
...
const renderBlockComponent = (block, index) => {
    switch (block.type) {
        ...
        case 'STRIKE':
            return (0, jsx_runtime_1.jsx)(StrikeSpan_1.default, { children: block.value }, index);
        case 'BOLD':
