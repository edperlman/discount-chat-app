...
test('updater typings', () => {
    const updater = new updater_1.UpdaterImpl();
    ...
    const omnichannel = new updater_1.UpdaterImpl();
...
test('updater $set operations', () => __awaiter(void 0, void 0, void 0, function* () {
    const updater = new updater_1.UpdaterImpl();
    updater.set('a', {
        b: 'set',
    });
...
test('updater $unset operations', () => __awaiter(void 0, void 0, void 0, function* () {
    const updater = new updater_1.UpdaterImpl();
    updater.unset('c');
    expect(updater.getUpdateFilter()).toEqual({ $unset: { c: 1 } });
}));
test('updater inc multiple operations', () => __awaiter(void 0, void 0, void 0, function* () {
    const updater = new updater_1.UpdaterImpl();
    updater.inc('c', 1);
    updater.inc('c', 1);
    expect(updater.getUpdateFilter()).toEqual({ $inc: { c: 2 } });
}));
test('it should add items to array', () => __awaiter(void 0, void 0, void 0, function* () {
    const updater = new updater_1.UpdaterImpl();
    updater.addToSet('a', 'b');
    updater.addToSet('a', 'c');
    expect(updater.getUpdateFilter()).toEqual({ $addToSet: { a: { $each: ['b', 'c'] } } });
}));
test('it should getUpdateFilter only once', () => __awaiter(void 0, void 0, void 0, function* () {
    const updater = new updater_1.UpdaterImpl();
    updater.set('a', {
        b: 'set',
    });
